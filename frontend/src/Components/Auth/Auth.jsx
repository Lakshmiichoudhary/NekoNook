        ...
        <div className="p-8">
          ...
          <form className="py-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="mb-6 relative">
              ...
              />
              <img
                className="absolute right-4 top-1/2 pt-1 cursor-pointer"
            ...
            <button
              ...
              className="w-full my-3 bg-orange-400 text-white hover:bg-orange-300 font-semibold py-2 rounded-lg"
            >
